    ...
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
          <div>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: '1.3rem', fontWeight: 750, marginBottom: 4 }}>
              {userName}
            </h2>
...
export default function UsersClient({ users, currentUserId }: { users: User[]; currentUserId: string }) {
  ...
  return (
    <div className="admin-users-content" style={{ padding: '32px 40px', maxWidth: 1200 }}>
      <h1 style={{ fontFamily: "'Syne', sans-serif", fontSize: '1.6rem', fontWeight: 750, marginBottom: 8 }}>
        Users
      </h1>
