...
export default function AcceptClient({
  ...
  return (
    <div className="dash-page-content" style={{ padding: '48px 56px', width: '100%', maxWidth: 800, margin: '0 auto' }}>
      ...
      <h1 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 750, fontSize: '1.5rem', margin: '0 0 8px' }}>
        Review & Accept
      </h1>
      ...
      {showConfirm && (
        ...
        >
          ...
          >
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 750, fontSize: '1.1rem', margin: '0 0 12px' }}>
