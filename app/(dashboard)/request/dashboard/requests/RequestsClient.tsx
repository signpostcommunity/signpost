  ...
  return (
    <div className="dash-page-content" style={{ padding: '48px 56px', width: '100%', maxWidth: 960 }}>
      ...
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 650, fontSize: '1.6rem', margin: '0 0 6px' }}>
          All Requests
        </h1>
      ...
      {cancelModalId && cancelBooking && (
        ...
        >
          ...
          >
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 650, fontSize: '1.15rem', margin: '0 0 12px' }}>
              Cancel this request?
            </h2>
