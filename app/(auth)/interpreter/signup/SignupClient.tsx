...
const EDUCATION_CARDS: EducationCard[] = [
  ...
  },
  {
    ...
    body: [
      ...
      <>Agencies charge an <em>hourly</em> fee on top of your rate. That fee can range from about $20 to $80+ <em>per hour</em>, but you may never know what the client actually paid. signpost charges a flat $15 booking fee to the requester. This covers the cost of building and running the platform: the booking system, encrypted messaging, notifications, and the interpreter directory. That is the only fee signpost collects.</>,
    ],
  },
  {
